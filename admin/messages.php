            ...
            <table class="admin-table">
                ...
                <tbody>
                    ...
                    <tr class="statut-<?= $msg->statut ?>">
                        ...
                        <td>
                            <a href="message_detail.php?id=<;?= $msg->id ?>" class="btn-view">👁️</a>
                            <?php if ($msg->statut == 'en_attente'): ?>
                                <a href="?action=approve&id=<?= $msg->id ?>" class="btn-approve" onclick="return confirm('Approuver ce message ?')">✅</a>
                                <a href="?action=reject&id=<?= $msg->id ?>" class="btn-reject" onclick="return confirm('Rejeter ce message ?')">❌</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                    <?php endforeach; ?>
